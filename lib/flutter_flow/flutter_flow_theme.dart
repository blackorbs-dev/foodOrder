...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFFEDE3);
  late Color tertiary = const Color(0xFFEAECF0);
  ...
  late Color accent1 = const Color(0xFF959595);
  late Color accent2 = const Color(0xFF474747);
  late Color accent3 = const Color(0xFFDADADA);
  ...
  late Color neutralsGray100 = const Color(0xFF474747);
  late Color gray200 = const Color(0xFFEBEDF1);
}
...
class ThemeTypography extends Typography {
  ...
  String get displayLargeFamily => 'Abhaya Libre';
  bool get displayLargeIsCustom => false;
  TextStyle get displayLarge => GoogleFonts.abhayaLibre(
        color: theme.info,
