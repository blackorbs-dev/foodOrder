                                  ...
                                  Flexible(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        FFAppState()
                                            .cartItems
                                            .elementAtOrNull(cartItemsIndex)!
                                            .image,
                                        width: 78.0,
                                        height: 62.0,
                                        fit: BoxFit.cover,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              '${FFAppState().cartItems.elementAtOrNull(cartItemsIndex)?.calories.toString()} Cal',
                                              style:
                        ...
                        FFButtonWidget(
                          onPressed: !functions.isHealthyOrder(
                              ...
                              : () async {
                                  ...
                                  safeSetState(() {});
                                  _model.cartResponse =
                                      await PlaceOrderCall.call(
                                    cartItemsDataJson: functions
                                        .mapToRequestData(
                                            FFAppState().cartItems.toList(),
                                            FFAppConstants.price)
                                        .map((e) => e.toMap())
                                  ...
                                  if (ApiResponseStruct.maybeFromMap(
                          ...
                          showLoadingIndicator: _model.loading,
                        ),
                      ],
                    ),
                  ),
